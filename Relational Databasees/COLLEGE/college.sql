...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2024 at 02:26 AM
...
('1', 'ec1719990', 'EC0001', NULL),
('10', 'ec1929265', 'EC0003', NULL),
('11', 'ec1843427', 'EC0003', NULL),
('12', 'ec1715553', 'EC0004', NULL),
('13', 'ec1928704', 'EC0004', NULL),
('14', 'ec1864542', 'EC0004', NULL),
('15', 'ec1840146', 'EC0005', NULL),
('16', 'ec1851770', 'EC0005', NULL),
('17', 'ec1859661', 'EC0005', NULL),
('18', 'ec1304184', 'EC0006', NULL),
('19', 'ec1864413', 'EC0006', NULL),
('2', 'ec1831770', 'EC0001', NULL),
('20', 'ec1839670', 'EC0007', NULL),
('21', 'ec1927333', 'EC0007', NULL),
('22', 'ec1848862', 'EC0007', NULL),
('23', 'ec1929485', 'EC0008', NULL),
('24', 'ec1930414', 'EC0008', NULL),
('25', 'ec1839440', 'EC0009', NULL),
('26', 'ec1858501', 'EC0009', NULL),
('27', 'ec1829437', 'EC0010', NULL),
('28', 'ec1843066', 'EC0010', NULL),
('29', 'ec1822859', 'EC0011', NULL),
('3', 'ec1840377', 'EC0001', NULL),
('30', 'ec1853157', 'EC0011', NULL),
('4', 'ec1861972', 'EC0001', NULL),
('5', 'ec1702958', 'EC0002', NULL),
('6', 'ec1834959', 'EC0002', NULL),
('7', 'ec1718024', 'EC0002', NULL),
('8', 'ec1928372', 'EC0002', NULL),
('9', 'ec1825661', 'EC0003', NULL);
...
ALTER TABLE `department`
  ...
  ADD KEY `fk_project` (`lecturer_id`);
...
ALTER TABLE `lecturer_module`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_project1` (`lecturer_id`),
  ADD KEY `fk_project4` (`moduleID`);
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `fk_project` FOREIGN KEY (`lecturer_id`) REFERENCES `lecturer` (`lecturer_id`);
...
--
ALTER TABLE `lecturer_module`
  ADD CONSTRAINT `fk_project1` FOREIGN KEY (`lecturer_id`) REFERENCES `lecturer` (`lecturer_id`),
  ADD CONSTRAINT `fk_project4` FOREIGN KEY (`moduleID`) REFERENCES `module` (`moduleID`);
COMMIT;
